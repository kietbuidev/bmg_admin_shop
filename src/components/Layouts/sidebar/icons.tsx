...
export function Mail(props: PropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M5.5 3.25h13a3.25 3.25 0 013.25 3.25v11a3.25 3.25 0 01-3.25 3.25h-13A3.25 3.25 0 012.25 17.5v-11A3.25 3.25 0 015.5 3.25zm13 1.5h-13A1.75 1.75 0 003.75 6.5v.28l7.55 4.708c.434.27.967.27 1.401 0l7.55-4.709V6.5a1.75 1.75 0 00-1.751-1.75zm1.75 4.073l-6.888 4.295a2.75 2.75 0 01-2.924 0L3.55 8.823V17.5A1.75 1.75 0 005.3 19.25h13a1.75 1.75 0 001.75-1.75V8.823z" />
    </svg>
  );
}
...
export function Box(props: PropsType) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M11.232 2.322a1.75 1.75 0 011.536 0l7.25 3.5A1.75 1.75 0 0121 7.406v9.188c0 .674-.379 1.289-.982 1.584l-7.25 3.5a1.75 1.75 0 01-1.536 0l-7.25-3.5A1.75 1.75 0 013 16.594V7.406c0-.674.379-1.289.982-1.584l7.25-3.5zM4.5 8.132v8.462l6.75 3.26V11.36L4.5 8.132zm14.75 8.462V8.132l-6.75 3.228v8.494l6.75-3.26zM12 3.75L5.743 6.75 12 9.75l6.257-3-6.257-3z" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M7.25 1.75h9.5a2.25 2.25 0 012.25 2.25v16.75a.75.75 0 01-1.2.6l-1.8-1.35-1.8 1.35a.75.75 0 01-.9 0l-1.8-1.35-1.8 1.35a.75.75 0 01-.9 0l-1.8-1.35-1.8 1.35a.75.75 0 01-1.2-.6V4a2.25 2.25 0 012.25-2.25zm0 1.5A.75.75 0 006.5 4v14.19l1.05-.79a.75.75 0 01.9 0l1.55 1.165 1.55-1.165a.75.75 0 01.9 0l1.55 1.165 1.55-1.165a.75.75 0 01.9 0l1.05.79V4a.75.75 0 00-.75-.75h-9.5z"
      />
      <path d="M9 7.25a.75.75 0 000 1.5h6a.75.75 0 000-1.5H9zM9 11.25a.75.75 0 000 1.5h6a.75.75 0 000-1.5H9zM9 15.25a.75.75 0 000 1.5h3.5a.75.75 0 000-1.5H9z" />
    </svg>
  );
}
